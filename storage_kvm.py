...
def build(
    ...
    """
    description:
        Creates storage_kvm on PodNet HA.
    ...
    # Define message
    messages = {
        1000: f'1000: Successfully created directory {domain_path}',
        2111: f'2011: Config file {domain_path} loaded.',
        3000: f'3000: Failed to create directory {domain_path}',
        ...
        3022: f'3022: Failed to create directory {domain_path} on the enabled PodNet'
        3031: f'3031: Successfully created directory {domain_path} on enabled PodNet but Failed to connect to the disabled PodNet '
              f'from the config file {config_file}',
        3032: f'3032: Successfully created directory {domain_path} on enabled PodNet but Failed to create on the disabled PodNet',
    }
