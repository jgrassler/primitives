...
def build(
    ...
    3061: f'Failed to connect to the enabled PodNet for flush_ruleset payload: ',
    3062: f'Failed to run flush_ruleset payload on the enabled PodNet. Payload exited with status ',
    3063: f'Failed to connect to the enabled PodNet for create_nat_table payload: ',
    3064: f'Failed to run create_nat_table payload on the enabled PodNet. Payload exited with status ',
    3065: f'Failed to connect to the enabled PodNet for create_filter_table payload: ',
    3066: f'Failed to run create_filter_table payload on the enabled PodNet. Payload exited with status ',
    3067: f'Failed to connect to the enabled PodNet for create_nat_postrouting_chain payload: ',
    3068: f'Failed to run create_nat_postrouting_chain payload on the enabled PodNet. Payload exited with status ',
    3069: f'Failed to connect to the enabled PodNet for create_nat_prerouting_chain payload: ',
    3070: f'Failed to run create_nat_prerouting_chain payload on the enabled PodNet. Payload exited with status ',
    3071: f'Failed to connect to the enabled PodNet for create_filter_postrouting_chain payload: ',
    3072: f'Failed to run create_filter_postrouting_chain payload on the enabled PodNet. Payload exited with status ',
    3073: f'Failed to connect to the enabled PodNet for create_filter_prerouting_chain payload: ',
    3074: f'Failed to run create_filter_prerouting_chain payload on the enabled PodNet. Payload exited with status ',
    3075: f'Failed to connect to the enabled PodNet for create_filter_output_chain payload: ',
    3076: f'Failed to run create_filter_output_chain payload on the enabled PodNet. Payload exited with status ',
    3077: f'Failed to connect to the enabled PodNet for create_filter_input_chain payload: ',
    3078: f'Failed to run create_filter_input_chain payload on the enabled PodNet. Payload exited with status ',
    3079: f'Failed to connect to the enabled PodNet for create_filter_forward_chain payload: ',
    3080: f'Failed to run create_filter_forward_chain payload on the enabled PodNet. Payload exited with status ',
    3081: f'Failed to connect to the enabled PodNet for create_filter_chain_set payload (%(payload)s): ',
    3082: f'Failed to run create_filter_chain_set payload (%(payload)s) on the enabled PodNet. Payload exited with status ',
    3083: f'Failed to connect to the enabled PodNet for create_user_chain payload (%(payload)s): ',
    3084: f'Failed to run create_user_chain payload (%(payload)s) on the enabled PodNet. Payload exited with status ',
    3085: f'Failed to connect to the enabled PodNet for create_rule payload (%(payload)s): ',
    3086: f'Failed to run create_rule payload (%(payload)s) on the enabled PodNet. Payload exited with status ',
    }
